...
class Candidate(models.Model):
    ...
    email = models.EmailField(max_length=135, verbose_name=u'邮箱')
    ...
    doctor_school = models.CharField(max_length=135, blank=True, verbose_name=u'博士学校')
    major = models.CharField(max_length=135, blank=True, verbose_name=u'专业')
    degree = models.CharField(max_length=135, blank=True, choices=DEGREE_TYPE, verbose_name=u'学历')
    ...
    hr_responsibility = models.CharField(max_length=10, blank=True, choices=HR_SCORE_TYPE, verbose_name=u'HR责任心')
    hr_communication_ability = models.CharField(max_length=10, blank=True, choices=HR_SCORE_TYPE,
